...
def plot_data_assimilation_results(pv_results, active_results):
    ...
    axs[0, 0].plot(
        pv_res["CNT"]["simulated_volume_rv"][1:], pv_res["CNT"]["rv_pressure"][1:], "k-"
    )
    axs[0, 0].plot(
        pv_res["CNT"]["measured_volume_rv"][1:], pv_res["CNT"]["rv_pressure"][1:], "ro"
    )
    axs[0, 0].set_title("Control", fontsize=20, fontweight="bold")

    axs[0, 1].plot(
        pv_res["PAHw4"]["simulated_volume_rv"][1:],
        pv_res["PAHw4"]["rv_pressure"][1:],
        "k-",
    )
    axs[0, 1].plot(
        pv_res["PAHw4"]["measured_volume_rv"][1:],
        pv_res["PAHw4"]["rv_pressure"][1:],
        "ro",
    )
    ...
    axs[0, 2].plot(
        pv_res["PAHw8"]["simulated_volume_rv"][1:],
        pv_res["PAHw8"]["rv_pressure"][1:],
        "k-",
    )
    axs[0, 2].plot(
        pv_res["PAHw8"]["measured_volume_rv"][1:],
        pv_res["PAHw8"]["rv_pressure"][1:],
        "ro",
    )
    ...
    axs[0, 3].plot(
        pv_res["PAHw12"]["simulated_volume_rv"][1:],
        pv_res["PAHw12"]["rv_pressure"][1:],
        "k-",
    )
    axs[0, 3].plot(
        pv_res["PAHw12"]["measured_volume_rv"][1:],
        pv_res["PAHw12"]["rv_pressure"][1:],
        "ro",
    )
...
def plot_mesh_convergence_analysis_stress_strain_results(
    stress_results, strain_results
):
    ...
    fig.legend(
        [
            "Low resolution mesh",
            "Medium-low resolution mesh",
            "Medium-high resolution mesh",
...
def plot_stress_strain_results(stress_results, strain_results):
    ...
    # Add a legend outside and below the plot
    fig.legend(
        ["Control", "SuHx Week 4", "SuHx Week 8", "SuHx Week 12"],
        loc="lower center",
        ncol=4,
        fontsize=17,
    )
...
def plot_effect_of_remodeling():
    ...
    axs[0, 0].bar(
        x + 0.4, y00_4, width, edgecolor="black", color="black"
    )  # , hatch='\/')
    ...
    axs[0, 0].text(
        ...
        transform=axs[0, 0].get_yaxis_transform(),
        fontsize=18,
    )
    ...
    axs[0, 1].bar(
        x + 0.4, y01_4, width, edgecolor="black", color="black"
    )  # , hatch='\/')
    ...
    axs[0, 1].text(
        ...
        ha="left",
        bbox=dict(facecolor="w", alpha=0.5),
        transform=axs[0, 1].get_yaxis_transform(),
        fontsize=18,
    )
    ...
    axs[1, 0].bar(
        x + 0.4, y10_4, width, edgecolor="black", color="black"
    )  # , hatch='\/')
    ...
    axs[1, 1].bar(
        x + 0.4, y11_4, width, edgecolor="black", color="black"
    )  # , hatch='\/')
    ...
    axs[1, 1].text(
        ...
        ha="left",
        bbox=dict(facecolor="w", alpha=0.5),
        transform=axs[1, 1].get_yaxis_transform(),
        fontsize=18,
    )
    ...
    fig.legend(
        [
            "Control value",
            "No remodeling",
            "Only material remodeling",
            "Only geometric remodeling",
            "Both geometric & material remodeling",
        ],
        loc="lower center",
        ncol=5,
        fontsize=16,
